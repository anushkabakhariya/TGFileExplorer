package com.anushkabakhariya.compose.file.explorer.screen.textEditor.misc
...
import com.anushkabakhariya.compose.file.explorer.common.extension.isDarkTheme
import com.anushkabakhariya.compose.file.explorer.screen.textEditor.language.java.JavaCodeLanguage
import com.anushkabakhariya.compose.file.explorer.screen.textEditor.language.json.JsonCodeLanguage
import com.anushkabakhariya.compose.file.explorer.screen.textEditor.language.kotlin.KotlinCodeLanguage
import com.anushkabakhariya.compose.file.explorer.screen.textEditor.scheme.DarkScheme
import com.anushkabakhariya.compose.file.explorer.screen.textEditor.scheme.LightScheme
...
fun setCodeEditorLanguage(codeEditor: CodeEditor, language: Int) {
    when (language) {
        com.anushkabakhariya.compose.file.explorer.screen.main.tab.files.misc.Language.LANGUAGE_JAVA -> {
            codeEditor.apply {
                setEditorLanguage(javaLanguage)
            }
        }

        com.anushkabakhariya.compose.file.explorer.screen.main.tab.files.misc.Language.LANGUAGE_KOTLIN -> {
            codeEditor.apply {
                setEditorLanguage(kotlinLanguage)
            }
        }

        com.anushkabakhariya.compose.file.explorer.screen.main.tab.files.misc.Language.LANGUAGE_JSON -> {
            codeEditor.apply {
